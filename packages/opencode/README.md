...
`OPENCODE_EXPERIMENTAL_NATIVE_LLM=1` bypasses this plugin's generic fetch seam on stock OpenCode 1.18.25. The plugin refuses observed custody entries under that mode; leave it unset for generic custody.
