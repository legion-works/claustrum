...
# The current measured total is 495 after adding the set-identity decrypt-arm,
# end-to-end usable-output pins, account-mismatch tests, and connected refusal coverage.
#
...
# but it should be a deliberate edit rather than a number nobody revisits.
  run_expect 495 "workspace unit + integration" \
